...
<body>
	...
	<div class="row">
		<div class="container">
			<h3 class="list-group-item active le-duoi"><?= $searchName ?></h3>
			<?php 
				$sql = "select * from sanpham where tenSanPham LIKE '%$searchName%' ORDER BY ngayTao DESC";
