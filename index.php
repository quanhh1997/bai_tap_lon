...
<body>
	...
	<nav class="navbar navbar-default" role="navigation">
		<div class="container">
			...
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				...
				<form action="sanpham/search.php" method="get" class="navbar-form navbar-left" role="search">
			    ...
			    <div id="carousel-simple" class="carousel slide" data-ride="carousel">
			      ...
			      <div class="carousel-inner" role="listbox">
			        <div class="item active">
			          <img src="sanpham/media/img/1.jpg" alt="" style="object-fit:cover">
			        </div>
			        <div class="item">
			          <img src="sanpham/media/img/2.jpg" alt="" style="object-fit:cover">
			        </div>
			        <div class="item">
			          <img src="sanpham/media/img/3.jpg" alt="" style="object-fit:cover">
			        </div>
			        <div class="item">
			          <img src="sanpham/media/img/4.jpg" alt="" style="object-fit:cover">
			        </div>
			      </div>
	...
	<div class="row">
		<div class="container">
			<h3 class="list-group-item active le-duoi">Sản phẩm mới</h3>
			<?php 
					$sqlsp = "SELECT * FROM sanpham ORDER BY ngayTao DESC";
					...
					foreach ($sp as $value) {
						...
						<div class="col-sm-6 col-md-3">
							<div class="thumbnail">
								<img src="sanpham/<?php echo $hinhAnh ?>" alt="<?= $tenSanPham ?> " width="200" height="250" class="anh">
								<div class="caption">
	...
	<div class="row">
		<div class="container">
			<h3 class="list-group-item active le-duoi">Tất cả sản phẩm</h3>
			<?php 
			...
			?>
					<div class="col-sm-6 col-md-3">
						<div class="thumbnail">
							<img src="sanpham/<?php echo $hinhAnh ?>" alt="<?= $tenSanPham ?> " width="200" height="200" class="anh">
							<div class="caption">
								<h3><?php echo $tenSanPham ?></h3>
								<p><?php echo $moTa ?></p>
								<p><a href="sanpham/sanpham.php?ma-san-pham=<?= $maSanPham ?>" class="btn btn-primary" role="button">Mua ngay</a> <span class="btn btn-default" role="button"><?php echo $gia.' VNĐ' ?></p>
		...
		<div class="container">
			<div class="col-md-12">
				<ul class="pagination">
					...
					<?php endif ?>
					<?php } ?>
					<li><a href="index.php?page=<?= $i-1 ?>">&raquo</a></li>
				</ul>
			</div>
		</div>
	</div>
